<{ include file="public/header.tpl" }>
	<div id="main">
		...
		<div class="column_left">
			...
			<div class="nav"> </div>
			<{/if}>
			<a href="http://bbs.lampbrother.net" target="_blank"><img src="<{$public}>/images/hulianwang.jpg" border="0" width="200" /></a>	
		</div>
		...
		<div class="sidebox">
        		...
        		<div class="dd dot">
					...
					<{ section name="rec" loop=$recommends }>
						<li><a href="<{$app}>/article/index/aid/<{ $recommends[rec].id }>"><{ $recommends[rec].title|truncate:15 }></a> <span style="font-size:10px">(<span class="redh"><{$recommends[rec].recommend}></span>人推荐)</span></li>
					<{ sectionelse }>
						<li>本类暂无推荐文章</li>
					<{ /section }>
          			</ul>
		...
		<div class="sidebox">
        		 ...
        		 <div class="dd dot">
					...
					<{ section name=h loop=$hots }>
						<li><a href="<{$app}>/article/index/aid/<{ $hots[h].id }>"><{ $hots[h].title|truncate:15}></a>&nbsp;&nbsp;<span style="font-size:10px">(浏览<span class="redh"><{$hots[h].views}></span>次)</span></li>
					<{ sectionelse }>
						<li>本类暂无热门文章</li>
					<{ /section }>
          			</ul>
