			...
			<div class="option">
				...
				<div id="menulist" class="content"> 
					...
					<div>
						...
						<ul id="list25">
						    <li><a class="list"  href="<{$app}>/play/add" target="main">添加幻灯</a></li>
						...
						<{/if}>
                                                ...
                                                <ul id="list26">
                                                          <li><a class="list"  href="<{$app}>/projects/add" target="main">添加项目</a></li>
							<li><a class="list"  href="<{$app}>/projects" target="main">管理项目</a></li>
